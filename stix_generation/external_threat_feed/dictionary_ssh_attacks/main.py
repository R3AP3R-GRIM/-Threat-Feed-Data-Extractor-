...
def main():
    ...
    if os.path.exists(config_file_path):
        ...
        url = config['URL']['dictionary_ssh_attacks']
        feed_name = 'dictionary_ssh_attacks'
